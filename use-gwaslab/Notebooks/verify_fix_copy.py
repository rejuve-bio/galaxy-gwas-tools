...
if os.path.exists(source_input):
    ...
    print(f"✅ Input copied: {target_input}")
...
# Ensure simple YAML content (no complex grep needed inside pipeline if possible, but pipeline greps it)
# Pipeline needs genome_assembly
